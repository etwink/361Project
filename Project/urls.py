...
urlpatterns = [
   ...
   path("home_Instructor/add_syllabus_pick_class/add_syllabus_create/add_syllabus_subscreen/add_syllabus_add_policy.html", views.add_syllabus_add_policy.as_view()),
