...
from syllabus_maker.views import home, home_Admin, home_Instructor, home_TA, admin_CreateNewUser, admin_CreateCourse, admin_AddCourseSection
...
urlpatterns = [
    ...
    path('admin_AddCourseSection/', admin_AddCourseSection.as_view()),
]
